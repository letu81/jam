...
!function (a) {
    var b = navigator.userAgent.toLowerCase(), c = function (a) {
        return a.test(b)
    }, d = Object.prototype.toString, e = c(/opera/), f = c(/\bchrome\b/), g = c(/webkit/), h = !f && c(/safari/), i = !e && c(/msie/), j = !!document.createElement("canvas").getContext, k = !g && c(/gecko/), l = c(/ipod|ipad|iphone|android/gi), m = {
        ...
        u.apply = function (a, b) {
            ...
            version: "1.0", email: "taylor@ichartjs.com", isEmpty: function (a, b) {
        ...
        return u.apply(u, {
            ...
            visible: function (a, b, c) {
                ...
                if (a = u.toPI2(a), b = u.toPI2(b), a >= b && (b += B), a > A)a = B; else {
                    if (b > B)return [{s: a, e: A, f: c}, {s: B, e: b, f: c}];
                    b > A && (b = A)
                }
                return {s: a, e: b, f: c}
            },
    ...
    a.Element = function (b) {
        ...
        c.type = "element", c.ICHARTJS_OBJECT = !0, a.DefineAbstract("configure", c), a.DefineAbstract("afterConfiguration", c), c.options = {}, c.set({
            border: {
                ...
                width: 1,
                radius: 0
            }, shadow: !1, shadow_color: "#666666", shadow_blur: 4, shadow_offsetx: 0, shadow_offsety: 0
        ...
        configure: function () {
            this.type = "painter", this.dimension = a._2D, a.DefineAbstract("commonDraw", this), a.DefineAbstract("initialize", this), this.set({
                ...
                originx: null,
                originy: null
            }), this.variable.event = {mouseover: !1}, this.variable.animation = {}, this.registerEvent("click", "mousemove", "mouseover", "mouseout", "beforedraw", "draw")
        }, is3D: function () {
        ...
        b.prototype = {
            getContext: function () {
                ...
                var o = b + h * d, p = c - h * e;
                return o = m(k, o), p = m(k, p), n && (this.polygon(i, j, k, l, n, !1, [{x: b, y: c}, {
                    x: o,
                    y: p
                }, {x: o + f, y: p}, {x: b + f, y: c}]), this.polygon(i, j, k, l, n, !1, [{x: b, y: c}, {
                    x: b,
                    y: c + g
                }, {x: b + f, y: c + g}, {x: b + f, y: c}]), this.polygon(i, j, k, l, n, !1, [{
                    x: b + f,
                    y: c
                }, {x: o + f, y: p}, {x: o + f, y: p + g}, {
                    x: b + f,
                    y: c + g
                }])), this.polygon(a.dark(i), j, k, l, !1, !1, [{x: b, y: c}, {x: o, y: p}, {x: o + f, y: p}, {
                    x: b + f,
                    y: c
                }]), this.polygon(i, j, k, l, !1, !1, [{x: b, y: c}, {x: b, y: c + g}, {x: b + f, y: c + g}, {
                    x: b + f,
                    y: c
                }]), this.polygon(a.dark(i), j, k, l, !1, !1, [{x: b + f, y: c}, {x: o + f, y: p}, {
                    x: o + f,
                    y: p + g
                }, {x: b + f, y: c + g}]), this
                ...
                return 0 > e ? a.isObject(n[4]) && p.push(a.applyIf({
                    ...
                    points: [{x: d, y: e}, {x: d, y: e - h}, {
                        x: d + g,
                        y: e - h
                    }, {x: d + g, y: e}]
                }, n[1])), a.isObject(n[2]) && p.push(a.applyIf({
                    points: [{x: b, y: c}, {x: b, y: c - h}, {
                        x: d,
                        y: e - h
                    }, {x: d, y: e}]
            ...
            configure: function () {
                a.Chart.superclass.configure.apply(this, arguments), this.type = "chart", this.dataType = "simple", this.set({
                    ...
                    showpercent: !1,
                    decimalsnum: 1,
                    empty: {text: "No data found", fontsize: 16},
        ...
        configure: function () {
            ...
            for (var B = 0; B <= b.number; B++)l = d ? b.get("labels")[B] : (g * B + i).toFixed(b.get("decimalsnum")), m = b.isH ? b.get("valid_x") + B * b.get("distanceOne") : b.x, n = b.isH ? b.y : b.get("valid_y") + b.get("valid_distance") - B * b.get("distanceOne"), b.items.push({
                ...
                originx: m + s,
                originy: n + t
            }, b.fireEvent(b, "parseText", [l, m + s, n + t, B, b.number == B]))), {textAlign: x, textBaseline: z}), b))
        }
    }), a.Coordinate = {
        ...
        configure: function () {
            ...
            }, s = a.applyIf(b.get("gridHStyle"), r), t = a.applyIf(b.get("gridVStyle"), r);
            if (l) {
                var u, v, w;
        ...
        configure: function () {
            ...
            if (b.push("inc_x", d * Math.cos(2 * Math.PI - c)), b.push("inc_y", d * Math.sin(2 * Math.PI - c)), d *= 2, b.get("label"))if (b.get("mini_label"))P2 = a.p2Point(b.x, b.y, c, b.get("donutwidth") ? b.r - b.get("donutwidth") / 2 : 5 * b.r / 8), b.doText(b, P2.x, P2.y); else {
                ...
                P2 = a.p2Point(b.x, b.y, c, b.r), b.doLabel(b, P2.x, P2.y, e, [{x: P2.x, y: P2.y}, {
                    x: g.x,
                    y: g.y
                }, {x: f.x, y: f.y}], f.x, f.y, .4 * d)
            }
        }
        ...
        configure: function () {
            ...
            lay = function (b, d, f, g) {
                ...
                z_index: b.get("z_index") + 1, drawFn: function () {
        ...
        configure: function () {
            a.Donut2D.superclass.configure.call(this), this.type = "donut2d", this.set({
                donutwidth: .3,
                center: {text: "", line_height: 24, fontweight: "bold", fontsize: 24}
            })
        }, doConfig: function () {
        ...
        configure: function () {
            ...
            a.get("area") && a.polygons.push([a.tf("area_color") || a.get("light_color2"), 0, a.get("brushsize"), 0, 0, a.get("area_opacity"), a.get("smooth") ? b : [{
                x: c,
                y: d
            }].concat(b.concat([{x: e, y: f}])), a.get("smooth"), a.get("smoothing") || 1.5, [{x: c, y: d}, {
                x: e,
                y: f
            }]])
        }, parse: function (b) {
